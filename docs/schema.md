...
- `passengers.pickupStopId` er uafhængig af turens `originId`. Administratoren og de tildelte chauffører kan vælge alle oprettede steder; salgschefen er fortsat begrænset til turens startsted.
